(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["InputRange"] = factory();
	else
		root["InputRange"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputRange = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autobindDecorator = __webpack_require__(37);
	
	var _autobindDecorator2 = _interopRequireDefault(_autobindDecorator);
	
	var _valueTransformer = __webpack_require__(38);
	
	var valueTransformer = _interopRequireWildcard(_valueTransformer);
	
	var _defaultClassNames = __webpack_require__(47);
	...
	var _rangePropType = __webpack_require__(49);
	
	var _rangePropType2 = _interopRequireDefault(_rangePropType);
	
	var _valuePropType = __webpack_require__(50);
	...
	var _track = __webpack_require__(52);
	
	var _track2 = _interopRequireDefault(_track);
	
	var _utils = __webpack_require__(39);
	
	var _keyCodes = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _captialize = __webpack_require__(40);
	...
	var _distanceTo = __webpack_require__(42);
	...
	var _isDefined = __webpack_require__(43);
	...
	var _length = __webpack_require__(46);
...
/***/ function(module, exports) {
	...
	*/
	var DEFAULT_CLASS_NAMES = {
	  ...
	  mark: 'input-range__mark',
	  markRegular: 'input-range__mark-regular',
	  markLabeled: 'input-range__mark-labeled'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mark = __webpack_require__(53);
	...
	var Track = (_class = function (_React$Component) {
	  ...
	  _createClass(Track, [{
	    ...
	    /**
	     * Return JSX for the Marks along the track
	     * @private
	     * @return {JSX.Element}
	     */
	    ...
	    value: function renderMarks() {
	      ...
	      var diff = max - min;
	      var marks = Array(diff);
	      for (var i = 0; i < diff; i++) {
	        var index = min + i;
	        var percentage = 100 / diff * i;
	        var type = index % 10 === 0 ? 'markLabeled' : 'markRegular';
	        var label = index % 10 === 0 ? '' + index : '';
	        if (index % 2 === 0) {
	          marks[i] = _react2.default.createElement(_mark2.default, { key: index, classNames: classNames, type: type, label: label, style: { left: percentage + '%' } });
	        }
	      }
	      return marks;
	    }
	...
	var Mark = function (_React$Component) {
	  ...
	  _createClass(Mark, [{
	    ...
	    value: function render() {
	      ...
	      var typeClassName = this.props.classNames[type];
	      var className = [this.props.classNames.mark, typeClassName].join(' ');
