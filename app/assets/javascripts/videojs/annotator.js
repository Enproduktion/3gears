...
Annotator = (function (_super) {
    ...
    Annotator.prototype.setupAnnotation = function (annotation) {
        ...
        // coming from backend
        if(annotation.tag_id && annotation.medium_id) {
            annotation.rangeTime = {
                start: annotation.start_time,
                end: annotation.end_time
            }
            annotation.tags = [annotation.tag_name]

            var container_id = 'medium_'+annotation.medium_id

            annotation.target = {
                container: container_id,
                src: $('#'+container_id+' video source').attr('src')
            }

            var userId = $('#'+container_id+' video').data('user')

            annotation.permissions = {admin: ["1"], delete: ["1"], update: ["1"], read: []}
            annotation.user = { id: userId, name: 'user', group: ''}

            annotation.media = 'video'
            annotation.created = annotation.created_at
            annotation.updated = annotation.updated_at
...
Annotator.Plugin.Store = (function (_super) {
    ...
    Store.prototype._onLoadAnnotationsFromSearch = function (data) {
        ...
        return this._onLoadAnnotations(data.medium_time_tags || []);
    };
    ...
    Store.prototype._apiRequest = function (action, obj, onSuccess) {
        ...
        if(obj.rangeTime && obj.tags[0]) {
            // map object
            json_data = {
                medium_time_tag: {
                    start_time: obj.rangeTime.start,
                    end_time: obj.rangeTime.end,
                    tag_name: obj.tags.join(", "),
                    text: obj.text
                }
            }
        } else {
        ...
        options = this._apiRequestOptions(action, json_data, onSuccess);
...
Annotator.Plugin.Tags = (function (_super) {
    ...
    Tags.prototype.pluginInit = function () {
        ...
        this.field = this.annotator.editor.addField({
            label: Annotator._t('Tags hinzufügen') + '\u2026',
